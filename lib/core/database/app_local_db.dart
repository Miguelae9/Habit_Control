...
/// Singleton wrapper around the application's local SQLite database.
///
/// Owns the connection, the schema (created in [_onCreate]) and the
/// migration logic (in [_onUpgrade]). Feature DBs use this instance to
