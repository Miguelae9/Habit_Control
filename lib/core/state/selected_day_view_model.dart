...
/// Tracks the day currently selected across the app.
///
/// Shared by dashboard, habits, input log and analytics so they all stay in
/// sync when the user navigates to a different day. Future days cannot be
/// selected.
class SelectedDayViewModel extends ChangeNotifier {
