...
class _EditMetricDialogState extends State<EditMetricDialog> {
  ...
  final List<DropdownMenuItem<String>> _interpretationItems =
      const <DropdownMenuItem<String>>[
        DropdownMenuItem(
          value: 'higher_better',
  ...
  Future<void> _save() async {
    ...
    try {
      await context.read<MetricsViewModel>().updateMetricDefinition(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: const InputDecoration(labelText: 'Semantic Category'),
              onChanged: (value) {
